    ...
    try:
        if db_conn["type"] == "asyncpg":
            ...
            result = await conn.fetchrow(
                ...
                (user_id, university, major, degree_level, graduation_year, current_status, bio, specialties, languages)
                VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
                RETURNING id, user_id, university, major, degree_level, graduation_year, current_status, 
                         bio, specialties, languages, verification_status, rating, total_sessions, 
                         success_rate, created_at, updated_at
                """,
                user_id, mentor_data.university, mentor_data.major, mentor_data.degree_level,
                mentor_data.graduation_year, mentor_data.current_status, mentor_data.bio,
                mentor_data.specialties, mentor_data.languages
            )
            ...
            result = client.table('mentorship_relationships').insert({
                ...
                'degree_level': mentor_data.degree_level,
                'graduation_year': mentor_data.graduation_year,
                'current_status': mentor_data.current_status,
                'bio': mentor_data.bio,
